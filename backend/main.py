...
"""
@app.get('/locations/zombie')
async def get_zombies():
    '''get all of the locations of the zombie hordes'''
    zombie_hordes_found = []

    # iterate through the database
    for i in range(len(locations_of_interest)):
        if locations_of_interest[i].type_of_landmark == TypeOfLandmark.zombie_horde :
            # add to zombie_hordes_found
            zombie_hordes_found.append(locations_of_interest[i])            

    return zombie_hordes_found
"""